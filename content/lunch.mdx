...
<Accordion title="Mediterranean Bowl" defaultOpen={true}>
- Salad or Grain Bowl
- Grain options:
...
- Chickpeas (plain or crispy)
  - Bake in oven 400 for 45 minutes, olive oil, salt, garlic powder seasoning
...
<Accordion title="Mexican Bowl" defaultOpen={true}>
- Salad or Grain Bowl
- Grain options:
